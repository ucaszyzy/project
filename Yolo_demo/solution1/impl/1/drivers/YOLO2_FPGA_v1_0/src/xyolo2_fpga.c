...
void XYolo2_fpga_Set_Input1(XYolo2_fpga *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo2_fpga_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_INPUT1_DATA, Data);
}

u32 XYolo2_fpga_Get_Input1(XYolo2_fpga *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo2_fpga_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_INPUT1_DATA);
    return Data;
}

void XYolo2_fpga_Set_Input2(XYolo2_fpga *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo2_fpga_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_INPUT2_DATA, Data);
}

u32 XYolo2_fpga_Get_Input2(XYolo2_fpga *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo2_fpga_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_INPUT2_DATA);
    return Data;
}

void XYolo2_fpga_Set_Input3(XYolo2_fpga *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo2_fpga_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_INPUT3_DATA, Data);
}

u32 XYolo2_fpga_Get_Input3(XYolo2_fpga *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo2_fpga_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_INPUT3_DATA);
    return Data;
}
...
void XYolo2_fpga_Set_Output1(XYolo2_fpga *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo2_fpga_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_OUTPUT1_DATA, Data);
}

u32 XYolo2_fpga_Get_Output1(XYolo2_fpga *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo2_fpga_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_OUTPUT1_DATA);
    return Data;
}
...
void XYolo2_fpga_Set_trow_loops(XYolo2_fpga *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo2_fpga_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_TROW_LOOPS_DATA, Data);
}

u32 XYolo2_fpga_Get_trow_loops(XYolo2_fpga *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo2_fpga_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO2_FPGA_CTRL_BUS_ADDR_TROW_LOOPS_DATA);
    return Data;
}
