...
set portList { 
	...
	{ input_buffer_0_address0 sc_out sc_lv 12 signal 8 } 
	{ input_buffer_0_ce0 sc_out sc_logic 1 signal 8 } 
	{ input_buffer_0_we0 sc_out sc_logic 1 signal 8 } 
	{ input_buffer_0_d0 sc_out sc_lv 16 signal 8 } 
	{ input_buffer_1_address0 sc_out sc_lv 12 signal 9 } 
	{ input_buffer_1_ce0 sc_out sc_logic 1 signal 9 } 
	{ input_buffer_1_we0 sc_out sc_logic 1 signal 9 } 
	{ input_buffer_1_d0 sc_out sc_lv 16 signal 9 } 
	{ input_buffer_2_address0 sc_out sc_lv 12 signal 10 } 
	{ input_buffer_2_ce0 sc_out sc_logic 1 signal 10 } 
	{ input_buffer_2_we0 sc_out sc_logic 1 signal 10 } 
	{ input_buffer_2_d0 sc_out sc_lv 16 signal 10 } 
	{ input_buffer_3_address0 sc_out sc_lv 12 signal 11 } 
	{ input_buffer_3_ce0 sc_out sc_logic 1 signal 11 } 
	{ input_buffer_3_we0 sc_out sc_logic 1 signal 11 } 
	{ input_buffer_3_d0 sc_out sc_lv 16 signal 11 } 
	{ r sc_in sc_lv 32 signal 12 } 
	{ c sc_in sc_lv 32 signal 13 } 
	{ n sc_in sc_lv 32 signal 14 } 
	{ Kernel_stride sc_in sc_lv 32 signal 15 } 
	{ Padding sc_in sc_lv 32 signal 16 } 
	{ TRow sc_in sc_lv 8 signal 17 } 
	{ TCol sc_in sc_lv 8 signal 18 } 
	{ Input_w sc_in sc_lv 32 signal 19 } 
	{ Input_h sc_in sc_lv 32 signal 20 } 
	{ TN_MIN sc_in sc_lv 32 signal 21 } 
	{ IHxIW sc_in sc_lv 19 signal 22 } 
	{ LayerType sc_in sc_lv 2 signal 23 } 
	{ trow_loops_V sc_in sc_lv 6 signal 24 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8", "9", "14", "15", "16", "17", "18"],
		"CDFG" : "input_load",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			{"Name" : "input_r", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input_r"}]},
			{"Name" : "input_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input1", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input1"}]},
			{"Name" : "input1_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input2", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input2"}]},
			{"Name" : "input2_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input3", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input3"}]},
			{"Name" : "input3_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input_buffer_0", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_buffer_0"}]},
			{"Name" : "input_buffer_1", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_buffer_1"}]},
			{"Name" : "input_buffer_2", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_buffer_2"}]},
			{"Name" : "input_buffer_3", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_buffer_3"}]},
			...
			{"Name" : "tmp_inoffset", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "tmp_inoffset"}]},
			{"Name" : "input_memcpy_buffer0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_memcpy_buffer"},
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input_memcpy_buffer"}]},
			{"Name" : "input_memcpy_buffer1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_memcpy_buffer1"},
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input_memcpy_buffer1"}]},
			{"Name" : "input_memcpy_buffer2", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_memcpy_buffer2"},
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input_memcpy_buffer2"}]},
			{"Name" : "input_memcpy_buffer3", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_memcpy_buffer3"},
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input_memcpy_buffer3"}]},
			{"Name" : "t2_local_V", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "t2_local_V"}]},
			...
			{"Name" : "input_memcpy_buffer3_1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "14", "SubInstance" : "grp_copy_input2buf_row_fu_391", "Port" : "input_memcpy_buffer3"},
					{"ID" : "9", "SubInstance" : "grp_mmcpy_inputpixel_m2b_fu_348", "Port" : "input_memcpy_buffer3"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_memcpy_buffer0_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_memcpy_buffer1_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_memcpy_buffer2_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_memcpy_buffer3_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_memcpy_buffer0_1_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_memcpy_buffer1_1_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_memcpy_buffer2_1_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_memcpy_buffer3_1_U", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mmcpy_inputpixel_m2b_fu_348", "Parent" : "0", "Child" : ["10", "11", "12", "13"],
		...
		"Port" : [
			{"Name" : "input_r", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_mmcpy_inputport_fu_250", "Port" : "input_r"}]},
			{"Name" : "input_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input1", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "12", "SubInstance" : "grp_mmcpy_inputport1_fu_274", "Port" : "input_r"}]},
			{"Name" : "input1_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input2", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_mmcpy_inputport2_fu_262", "Port" : "input_r"}]},
			{"Name" : "input2_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input3", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "grp_mmcpy_inputport3_fu_286", "Port" : "input_r"}]},
			{"Name" : "input3_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input_memcpy_buffer", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_mmcpy_inputport_fu_250", "Port" : "input_memcpy_buffer"}]},
			{"Name" : "input_memcpy_buffer1", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "12", "SubInstance" : "grp_mmcpy_inputport1_fu_274", "Port" : "input_memcpy_buffer"}]},
			{"Name" : "input_memcpy_buffer2", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "grp_mmcpy_inputport2_fu_262", "Port" : "input_memcpy_buffer"}]},
			{"Name" : "input_memcpy_buffer3", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "grp_mmcpy_inputport3_fu_286", "Port" : "input_memcpy_buffer"}]},
			...
			{"Name" : "tmp_inoffset", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mmcpy_inputpixel_m2b_fu_348.grp_mmcpy_inputport_fu_250", "Parent" : "9",
	...
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mmcpy_inputpixel_m2b_fu_348.grp_mmcpy_inputport2_fu_262", "Parent" : "9",
		...
		"Port" : [
			...
			{"Name" : "RowOffset", "Type" : "None", "Direction" : "I"},
			{"Name" : "RowIntNum", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mmcpy_inputpixel_m2b_fu_348.grp_mmcpy_inputport1_fu_274", "Parent" : "9",
		...
		"Port" : [
			...
			{"Name" : "RowOffset", "Type" : "None", "Direction" : "I"},
			{"Name" : "RowIntNum", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mmcpy_inputpixel_m2b_fu_348.grp_mmcpy_inputport3_fu_286", "Parent" : "9",
		...
		"Port" : [
			...
			{"Name" : "RowOffset", "Type" : "None", "Direction" : "I"},
			{"Name" : "RowIntNum", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_input2buf_row_fu_391", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "t2_local_V", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.YOLO2_FPGA_mac_mujbC_U76", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.YOLO2_FPGA_mac_mujbC_U77", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.YOLO2_FPGA_mul_mukbM_U78", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.YOLO2_FPGA_mac_mulbW_U79", "Parent" : "0"}]}
