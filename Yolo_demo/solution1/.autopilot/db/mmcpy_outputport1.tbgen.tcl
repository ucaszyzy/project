set moduleName mmcpy_outputport1
...
set C_modelArgMapList {[ 
	{ "Name" : "Output_r", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "tm_V_2", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "mLoop_V", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tm_V_2 sc_in sc_lv 6 signal 3 } 
	{ mLoop_V sc_in sc_lv 6 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tm_V_2", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "tm_V_2", "role": "default" }} , 
 	{ "name": "mLoop_V", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "mLoop_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	tm_V_2 { ap_none {  { tm_V_2 in_data 0 6 } } }
	mLoop_V { ap_none {  { mLoop_V in_data 0 6 } } }
