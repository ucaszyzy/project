...
#ifndef __YOLO2_FPGA_mac_musc4__HH__
#define __YOLO2_FPGA_mac_musc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_musc4) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_musc4):  simcore_mac_6_U ("simcore_mac_6_U") {
