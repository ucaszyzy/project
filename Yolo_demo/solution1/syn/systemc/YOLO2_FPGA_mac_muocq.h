...
#ifndef __YOLO2_FPGA_mac_muocq__HH__
#define __YOLO2_FPGA_mac_muocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_muocq) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_muocq):  simcore_mac_2_U ("simcore_mac_2_U") {
