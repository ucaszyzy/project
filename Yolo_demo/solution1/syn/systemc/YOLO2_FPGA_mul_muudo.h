...
#ifndef __YOLO2_FPGA_mul_muudo__HH__
#define __YOLO2_FPGA_mul_muudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mul_muudo) {
    ...
    SC_CTOR(YOLO2_FPGA_mul_muudo):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
