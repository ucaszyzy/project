...
#ifndef __YOLO2_FPGA_mac_mueRU__HH__
#define __YOLO2_FPGA_mac_mueRU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_mueRU) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_mueRU):  simcore_mac_8_U ("simcore_mac_8_U") {
