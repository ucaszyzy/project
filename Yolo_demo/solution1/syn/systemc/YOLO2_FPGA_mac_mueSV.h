...
#ifndef __YOLO2_FPGA_mac_mueSV__HH__
#define __YOLO2_FPGA_mac_mueSV__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_mueSV) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_mueSV):  simcore_mac_9_U ("simcore_mac_9_U") {
