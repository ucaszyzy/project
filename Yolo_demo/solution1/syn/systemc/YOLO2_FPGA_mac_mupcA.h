...
#ifndef __YOLO2_FPGA_mac_mupcA__HH__
#define __YOLO2_FPGA_mac_mupcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_mupcA) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_mupcA):  simcore_mac_3_U ("simcore_mac_3_U") {
