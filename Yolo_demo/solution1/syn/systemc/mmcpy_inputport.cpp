...
const sc_logic mmcpy_inputport::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic mmcpy_inputport::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state1 = "1";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state2 = "10";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state3 = "100";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state4 = "1000";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state5 = "10000";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state6 = "100000";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state7 = "1000000";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state8 = "10000000";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_pp0_stage0 = "100000000";
const sc_lv<10> mmcpy_inputport::ap_ST_fsm_state12 = "1000000000";
const bool mmcpy_inputport::ap_const_boolean_1 = true;
const sc_lv<32> mmcpy_inputport::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<1> mmcpy_inputport::ap_const_lv1_0 = "0";
const sc_lv<3> mmcpy_inputport::ap_const_lv3_0 = "000";
const sc_lv<2> mmcpy_inputport::ap_const_lv2_0 = "00";
const sc_lv<4> mmcpy_inputport::ap_const_lv4_0 = "0000";
const sc_lv<32> mmcpy_inputport::ap_const_lv32_1 = "1";
const sc_lv<32> mmcpy_inputport::ap_const_lv32_8 = "1000";
const bool mmcpy_inputport::ap_const_boolean_0 = false;
const sc_lv<32> mmcpy_inputport::ap_const_lv32_7 = "111";
const sc_lv<1> mmcpy_inputport::ap_const_lv1_1 = "1";
const sc_lv<6> mmcpy_inputport::ap_const_lv6_0 = "000000";
const sc_lv<6> mmcpy_inputport::ap_const_lv6_1 = "1";
const sc_lv<32> mmcpy_inputport::ap_const_lv32_9 = "1001";

mmcpy_inputport::mmcpy_inputport(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_ap_phi_mux_indvar_phi_fu_120_p4);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( exitcond_reg_204 );
    sensitive << ( indvar_reg_116 );
    sensitive << ( indvar_next_reg_208 );
    ...
    SC_METHOD(thread_enable_fu_132_p2);
    sensitive << ( ap_start );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( TN_MIN_V );
    ...
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_phi_mux_indvar_phi_fu_120_p4 );

    SC_METHOD(thread_indvar1_fu_173_p1);
    sensitive << ( indvar_reg_116_pp0_iter1_reg );

    SC_METHOD(thread_indvar_next_fu_167_p2);
    sensitive << ( ap_phi_mux_indvar_phi_fu_120_p4 );

    SC_METHOD(thread_input_memcpy_buffer_address0);
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( indvar1_fu_173_p1 );
    ...
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( input_addr_read_reg_213 );
    sensitive << ( ap_enable_reg_pp0_iter2 );

    SC_METHOD(thread_input_memcpy_buffer_we0);
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( exitcond_reg_204_pp0_iter1_reg );
    sensitive << ( ap_enable_reg_pp0_iter2 );

    SC_METHOD(thread_input_offset_cast_fu_128_p1);
    ...
    SC_METHOD(thread_sum_cast_fu_148_p1);
    sensitive << ( sum_reg_188 );

    SC_METHOD(thread_sum_fu_142_p2);
    sensitive << ( tmp_cast_fu_138_p1 );
    sensitive << ( input_offset_cast_fu_128_p1 );
    ...
    apTFilenSS << "mmcpy_inputport_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, indvar_reg_116_pp0_iter1_reg, "indvar_reg_116_pp0_iter1_reg");
    ...
    sc_trace(mVcdFile, enable_fu_132_p2, "enable_fu_132_p2");
    sc_trace(mVcdFile, sum_fu_142_p2, "sum_fu_142_p2");
    sc_trace(mVcdFile, sum_reg_188, "sum_reg_188");
    ...
    sc_trace(mVcdFile, exitcond_reg_204_pp0_iter1_reg, "exitcond_reg_204_pp0_iter1_reg");
    sc_trace(mVcdFile, indvar_next_fu_167_p2, "indvar_next_fu_167_p2");
    sc_trace(mVcdFile, indvar_next_reg_208, "indvar_next_reg_208");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter0, "ap_enable_reg_pp0_iter0");
    sc_trace(mVcdFile, input_addr_read_reg_213, "input_addr_read_reg_213");
    ...
    sc_trace(mVcdFile, ap_phi_mux_indvar_phi_fu_120_p4, "ap_phi_mux_indvar_phi_fu_120_p4");
    sc_trace(mVcdFile, indvar1_fu_173_p1, "indvar1_fu_173_p1");
    sc_trace(mVcdFile, sum_cast_fu_148_p1, "sum_cast_fu_148_p1");
    ...
    sc_trace(mVcdFile, input_offset_cast_fu_128_p1, "input_offset_cast_fu_128_p1");
...
mmcpy_inputport::~mmcpy_inputport() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void mmcpy_inputport::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        indvar_reg_116 = indvar_next_reg_208.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read())) {
        indvar_reg_116 = ap_const_lv6_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        exitcond_reg_204 = exitcond_fu_162_p2.read();
        exitcond_reg_204_pp0_iter1_reg = exitcond_reg_204.read();
        indvar_reg_116_pp0_iter1_reg = indvar_reg_116.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter0.read(), ap_const_logic_1))) {
        indvar_next_reg_208 = indvar_next_fu_167_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        input_addr_read_reg_213 = m_axi_input_r_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(enable_fu_132_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        sum_reg_188 = sum_fu_142_p2.read();
    }
}

void mmcpy_inputport::thread_ap_CS_fsm_pp0_stage0() {
    ap_CS_fsm_pp0_stage0 = ap_CS_fsm.read()[8];
}

void mmcpy_inputport::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void mmcpy_inputport::thread_ap_CS_fsm_state12() {
    ap_CS_fsm_state12 = ap_CS_fsm.read()[9];
}

void mmcpy_inputport::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void mmcpy_inputport::thread_ap_CS_fsm_state8() {
    ap_CS_fsm_state8 = ap_CS_fsm.read()[7];
}

void mmcpy_inputport::thread_ap_block_pp0_stage0() {
    ap_block_pp0_stage0 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void mmcpy_inputport::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_input_r_RVALID.read()));
}

void mmcpy_inputport::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_input_r_RVALID.read()));
}

void mmcpy_inputport::thread_ap_block_state10_pp0_stage0_iter1() {
    ap_block_state10_pp0_stage0_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_input_r_RVALID.read()));
}

void mmcpy_inputport::thread_ap_block_state11_pp0_stage0_iter2() {
    ap_block_state11_pp0_stage0_iter2 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void mmcpy_inputport::thread_ap_block_state9_pp0_stage0_iter0() {
    ap_block_state9_pp0_stage0_iter0 = !esl_seteq<1,1,1>(ap_const_boolean_1, ap_const_boolean_1);
}

void mmcpy_inputport::thread_ap_condition_pp0_exit_iter0_state9() {
...
void mmcpy_inputport::thread_ap_done() {
...
void mmcpy_inputport::thread_ap_enable_pp0() {
    ap_enable_pp0 = (ap_idle_pp0.read() ^ ap_const_logic_1);
}

void mmcpy_inputport::thread_ap_idle() {
    if ((esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void mmcpy_inputport::thread_ap_idle_pp0() {
...
void mmcpy_inputport::thread_ap_phi_mux_indvar_phi_fu_120_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204.read()))) {
        ap_phi_mux_indvar_phi_fu_120_p4 = indvar_next_reg_208.read();
    } else {
        ap_phi_mux_indvar_phi_fu_120_p4 = indvar_reg_116.read();
    }
}

void mmcpy_inputport::thread_ap_ready() {
...
void mmcpy_inputport::thread_ap_sig_ioackin_m_axi_input_r_ARREADY() {
...
void mmcpy_inputport::thread_enable_fu_132_p2() {
    enable_fu_132_p2 = (!TN_MIN_V.read().is_01() || !ap_const_lv3_0.is_01())? sc_lv<1>(): sc_lv<1>(TN_MIN_V.read() == ap_const_lv3_0);
}

void mmcpy_inputport::thread_exitcond_fu_162_p2() {
    exitcond_fu_162_p2 = (!ap_phi_mux_indvar_phi_fu_120_p4.read().is_01() || !RowIntNum.read().is_01())? sc_lv<1>(): sc_lv<1>(ap_phi_mux_indvar_phi_fu_120_p4.read() == RowIntNum.read());
}

void mmcpy_inputport::thread_indvar1_fu_173_p1() {
    indvar1_fu_173_p1 = esl_zext<64,6>(indvar_reg_116_pp0_iter1_reg.read());
}

void mmcpy_inputport::thread_indvar_next_fu_167_p2() {
    indvar_next_fu_167_p2 = (!ap_phi_mux_indvar_phi_fu_120_p4.read().is_01() || !ap_const_lv6_1.is_01())? sc_lv<6>(): (sc_biguint<6>(ap_phi_mux_indvar_phi_fu_120_p4.read()) + sc_biguint<6>(ap_const_lv6_1));
}

void mmcpy_inputport::thread_input_memcpy_buffer_address0() {
    input_memcpy_buffer_address0 =  (sc_lv<5>) (indvar1_fu_173_p1.read());
}

void mmcpy_inputport::thread_input_memcpy_buffer_ce0() {
...
void mmcpy_inputport::thread_input_memcpy_buffer_d0() {
    input_memcpy_buffer_d0 = input_addr_read_reg_213.read();
}

void mmcpy_inputport::thread_input_memcpy_buffer_we0() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_enable_reg_pp0_iter2.read(), ap_const_logic_1) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204_pp0_iter1_reg.read()))) {
...
void mmcpy_inputport::thread_input_offset_cast_fu_128_p1() {
    input_offset_cast_fu_128_p1 = esl_zext<32,30>(input_offset.read());
}

void mmcpy_inputport::thread_input_r_blk_n_AR() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
...
void mmcpy_inputport::thread_input_r_blk_n_R() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204.read()))) {
...
void mmcpy_inputport::thread_m_axi_input_r_ARADDR() {
    m_axi_input_r_ARADDR =  (sc_lv<32>) (sum_cast_fu_148_p1.read());
}

void mmcpy_inputport::thread_m_axi_input_r_ARBURST() {
    m_axi_input_r_ARBURST = ap_const_lv2_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARCACHE() {
    m_axi_input_r_ARCACHE = ap_const_lv4_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARID() {
    m_axi_input_r_ARID = ap_const_lv1_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARLEN() {
    m_axi_input_r_ARLEN = esl_zext<32,6>(RowIntNum.read());
}

void mmcpy_inputport::thread_m_axi_input_r_ARLOCK() {
    m_axi_input_r_ARLOCK = ap_const_lv2_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARPROT() {
    m_axi_input_r_ARPROT = ap_const_lv3_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARQOS() {
    m_axi_input_r_ARQOS = ap_const_lv4_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARREGION() {
    m_axi_input_r_ARREGION = ap_const_lv4_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARSIZE() {
    m_axi_input_r_ARSIZE = ap_const_lv3_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARUSER() {
    m_axi_input_r_ARUSER = ap_const_lv1_0;
}

void mmcpy_inputport::thread_m_axi_input_r_ARVALID() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
...
void mmcpy_inputport::thread_m_axi_input_r_AWADDR() {
    m_axi_input_r_AWADDR = ap_const_lv32_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWBURST() {
    m_axi_input_r_AWBURST = ap_const_lv2_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWCACHE() {
    m_axi_input_r_AWCACHE = ap_const_lv4_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWID() {
    m_axi_input_r_AWID = ap_const_lv1_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWLEN() {
    m_axi_input_r_AWLEN = ap_const_lv32_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWLOCK() {
    m_axi_input_r_AWLOCK = ap_const_lv2_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWPROT() {
    m_axi_input_r_AWPROT = ap_const_lv3_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWQOS() {
    m_axi_input_r_AWQOS = ap_const_lv4_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWREGION() {
    m_axi_input_r_AWREGION = ap_const_lv4_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWSIZE() {
    m_axi_input_r_AWSIZE = ap_const_lv3_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWUSER() {
    m_axi_input_r_AWUSER = ap_const_lv1_0;
}

void mmcpy_inputport::thread_m_axi_input_r_AWVALID() {
    m_axi_input_r_AWVALID = ap_const_logic_0;
}

void mmcpy_inputport::thread_m_axi_input_r_BREADY() {
    m_axi_input_r_BREADY = ap_const_logic_0;
}

void mmcpy_inputport::thread_m_axi_input_r_RREADY() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_reg_204.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
...
void mmcpy_inputport::thread_m_axi_input_r_WDATA() {
    m_axi_input_r_WDATA = ap_const_lv32_0;
}

void mmcpy_inputport::thread_m_axi_input_r_WID() {
    m_axi_input_r_WID = ap_const_lv1_0;
}

void mmcpy_inputport::thread_m_axi_input_r_WLAST() {
    m_axi_input_r_WLAST = ap_const_logic_0;
}

void mmcpy_inputport::thread_m_axi_input_r_WSTRB() {
    m_axi_input_r_WSTRB = ap_const_lv4_0;
}

void mmcpy_inputport::thread_m_axi_input_r_WUSER() {
    m_axi_input_r_WUSER = ap_const_lv1_0;
}

void mmcpy_inputport::thread_m_axi_input_r_WVALID() {
    m_axi_input_r_WVALID = ap_const_logic_0;
}

void mmcpy_inputport::thread_sum_cast_fu_148_p1() {
    sum_cast_fu_148_p1 = esl_sext<64,32>(sum_reg_188.read());
}

void mmcpy_inputport::thread_sum_fu_142_p2() {
    sum_fu_142_p2 = (!tmp_cast_fu_138_p1.read().is_01() || !input_offset_cast_fu_128_p1.read().is_01())? sc_lv<32>(): (sc_bigint<32>(tmp_cast_fu_138_p1.read()) + sc_biguint<32>(input_offset_cast_fu_128_p1.read()));
}

void mmcpy_inputport::thread_tmp_cast_fu_138_p1() {
    tmp_cast_fu_138_p1 = esl_sext<32,31>(RowOffset.read());
}

void mmcpy_inputport::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && esl_seteq<1,1,1>(enable_fu_132_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state12;
            } else if ((esl_seteq<1,1,1>(enable_fu_132_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
  ...
  esl_seteq<1,1,1>(ap_const_boolean_0, ap_block_pp0_stage0_subdone.read()) && 
  esl_seteq<1,1,1>(exitcond_fu_162_p2.read(), ap_const_lv1_1) && 
