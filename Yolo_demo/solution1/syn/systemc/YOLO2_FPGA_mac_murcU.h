...
#ifndef __YOLO2_FPGA_mac_murcU__HH__
#define __YOLO2_FPGA_mac_murcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_murcU) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_murcU):  simcore_mac_5_U ("simcore_mac_5_U") {
