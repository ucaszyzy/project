...
#ifndef __YOLO2_FPGA_mac_muqcK__HH__
#define __YOLO2_FPGA_mac_muqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_muqcK) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_muqcK):  simcore_mac_4_U ("simcore_mac_4_U") {
