...
#ifndef __YOLO2_FPGA_mac_mutde__HH__
#define __YOLO2_FPGA_mac_mutde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_mutde) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_mutde):  simcore_mac_7_U ("simcore_mac_7_U") {
