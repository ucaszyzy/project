...
#ifndef _mmcpy_inputport1_HH_
#define _mmcpy_inputport1_HH_
...
struct mmcpy_inputport1 : public sc_module {
    ...
    // Module declarations
    mmcpy_inputport1(sc_module_name name);
    SC_HAS_PROCESS(mmcpy_inputport1);
    ...
    sc_signal< sc_lv<1> > exitcond_reg_218;
    ...
    sc_signal< sc_lv<1> > enable_fu_146_p2;
    sc_signal< sc_lv<32> > sum_fu_156_p2;
    sc_signal< sc_lv<32> > sum_reg_202;
    sc_signal< sc_logic > ap_sig_ioackin_m_axi_input_r_ARREADY;
    sc_signal< sc_lv<1> > exitcond_fu_176_p2;
    sc_signal< sc_lv<1> > exitcond_reg_218_pp0_iter1_reg;
    sc_signal< sc_lv<6> > indvar_next_fu_181_p2;
    sc_signal< sc_lv<6> > indvar_next_reg_222;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<32> > input_addr_read_reg_227;
    ...
    sc_signal< sc_lv<64> > indvar1_fu_187_p1;
    sc_signal< sc_lv<64> > sum_cast_fu_162_p1;
    sc_signal< sc_logic > ap_reg_ioackin_m_axi_input_r_ARREADY;
    sc_signal< sc_lv<2> > tmp_fu_136_p4;
    sc_signal< sc_lv<32> > tmp_cast_fu_152_p1;
    ...
    void thread_enable_fu_146_p2();
    void thread_exitcond_fu_176_p2();
    void thread_indvar1_fu_187_p1();
    void thread_indvar_next_fu_181_p2();
    ...
    void thread_sum_cast_fu_162_p1();
    void thread_sum_fu_156_p2();
