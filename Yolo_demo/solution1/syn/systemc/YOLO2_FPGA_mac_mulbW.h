...
#ifndef __YOLO2_FPGA_mac_mulbW__HH__
#define __YOLO2_FPGA_mac_mulbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_mulbW) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_mulbW):  simcore_mac_1_U ("simcore_mac_1_U") {
