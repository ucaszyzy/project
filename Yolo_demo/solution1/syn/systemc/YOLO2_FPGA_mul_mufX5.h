...
#ifndef __YOLO2_FPGA_mul_mufX5__HH__
#define __YOLO2_FPGA_mul_mufX5__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mul_mufX5) {
    ...
    SC_CTOR(YOLO2_FPGA_mul_mufX5):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
