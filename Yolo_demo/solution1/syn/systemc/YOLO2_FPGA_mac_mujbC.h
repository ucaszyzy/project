...
#ifndef __YOLO2_FPGA_mac_mujbC__HH__
#define __YOLO2_FPGA_mac_mujbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mac_mujbC) {
    ...
    SC_CTOR(YOLO2_FPGA_mac_mujbC):  simcore_mac_0_U ("simcore_mac_0_U") {
