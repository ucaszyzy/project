...
#ifndef __YOLO2_FPGA_mul_mueQU__HH__
#define __YOLO2_FPGA_mul_mueQU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_mul_mueQU) {
    ...
    SC_CTOR(YOLO2_FPGA_mul_mueQU):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
