...
#ifndef __YOLO2_FPGA_ama_adfW5__HH__
#define __YOLO2_FPGA_ama_adfW5__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(YOLO2_FPGA_ama_adfW5) {
    ...
    SC_CTOR(YOLO2_FPGA_ama_adfW5):  simcore_ama_0_U ("simcore_ama_0_U") {
