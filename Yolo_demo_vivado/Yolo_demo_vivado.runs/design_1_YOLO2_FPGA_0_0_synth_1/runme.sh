...
HD_PWD='D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.runs/design_1_YOLO2_FPGA_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_YOLO2_FPGA_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_YOLO2_FPGA_0_0.tcl
