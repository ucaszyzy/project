...
read_ip -quiet d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0.xci
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.runs/design_1_axi_smc_3_0_synth_1 -new_name design_1_axi_smc_3_0 -ip [get_ips design_1_axi_smc_3_0]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top design_1_axi_smc_3_0 -part xc7z020clg400-1 -mode out_of_context
...
set TIME_taken [expr [clock seconds] - $TIME_start]
 ...
 config_ip_cache -add -dcp design_1_axi_smc_3_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips design_1_axi_smc_3_0]
}
...
if { [catch {
  file copy -force D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.runs/design_1_axi_smc_3_0_synth_1/design_1_axi_smc_3_0.dcp d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.runs/design_1_axi_smc_3_0_synth_1/design_1_axi_smc_3_0_stub.v d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.runs/design_1_axi_smc_3_0_synth_1/design_1_axi_smc_3_0_stub.vhdl d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.runs/design_1_axi_smc_3_0_synth_1/design_1_axi_smc_3_0_sim_netlist.v d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.runs/design_1_axi_smc_3_0_synth_1/design_1_axi_smc_3_0_sim_netlist.vhdl d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.ip_user_files/ip/design_1_axi_smc_3_0]} {
  catch { 
    file copy -force d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_stub.v D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.ip_user_files/ip/design_1_axi_smc_3_0
  }
}

if {[file isdir D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.ip_user_files/ip/design_1_axi_smc_3_0]} {
  catch { 
    file copy -force d:/pro/Yolo_demo_vivado/Yolo_demo_vivado.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_3_0/design_1_axi_smc_3_0_stub.vhdl D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.ip_user_files/ip/design_1_axi_smc_3_0
  }
}
