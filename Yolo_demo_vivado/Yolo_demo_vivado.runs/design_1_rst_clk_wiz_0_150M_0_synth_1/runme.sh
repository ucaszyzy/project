...
HD_PWD='D:/pro/Yolo_demo_vivado/Yolo_demo_vivado.runs/design_1_rst_clk_wiz_0_150M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_0_150M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_0_150M_0.tcl
